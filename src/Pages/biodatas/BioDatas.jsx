...
const BioDatas = () => {
  ...
  const {
    data: allBioData = [],
    isLoading: allBioLoading,
    refetch: AllBioDataFetch,
  } = useQuery({
    ...
    <div>
      ...
      <div className="container relative flex py-6 mx-auto">
          ...
          <div className="border-y border-gray-300 px-2 py-12">
            ...
            <div className="mt-12">
              <button
                ...
                className="bg-blue-800 hover:bg-blue-400 hover:text-black font-semibold w-full py-2 text-white px-6"
              >
                Reset
              </button>
            </div>
        ...
        <div
          ...
          } z-10 flex flex-col lg:hidden  py-6 px-4 h-full min-h-[90vh] bg-slate-100`}
        >
          <h1 className="flex mb-20  font-bold text-blue-800 text-2xl items-center gap-2">
            <IoFilterSharp />
            Filter Bio
