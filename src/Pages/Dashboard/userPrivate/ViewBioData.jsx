            ...
            <div className="lg:w-6/12  ">
              ...
              <div className="">
                {userData?.type === "normal" && (
                  <button onClick={premiumBtnHandler} className="btn py-3 px-6">
                    Make Biodata Premium
                  </button>
                )}
                {userData?.type === "pending" && (
                  <button className="py-3 px-6 bg-gray-200 hover:cursor-not-allowed">
